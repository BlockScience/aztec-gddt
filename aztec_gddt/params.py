...
def create_experiments(
    ...
    L1_INTER_SHOCK_AMPLITUDE: float = 100,
    L1_INTER_SHOCK_PERIOD: float = 10,
):
    ...
    intermit_shock_gas_fee_l1_time_series[0:initial_time] = (
        steady_gas_fee_l1_time_series[0:initial_time].copy()
    )
    ...
    # Put together series for censorship
